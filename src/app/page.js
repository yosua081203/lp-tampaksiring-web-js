...
export default function Home() {
  ...
  return (
        ...
        <section id="kontak" className="section contact-map-section">
            ...
            <div className="contact-map-container" data-aos="fade-up">
                <div className="contact-form-area">
                    ...
                    {/* BARU: SECTION SUPPORTED BY (Di dalam Contact Form Area) */}
    ...
    <footer>
        <p>© 2025 Desa Wisata Tampaksiring. <span className="tagline" data-lang-key="footer_tagline">{langData.footer_tagline}</span></p>
    </footer>
